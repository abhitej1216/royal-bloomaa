...
-------------------------------- */
    ...
    var $html = $('html');
    var $body = $('body');
    var $elementCarousel = $('.royal-element-carousel');
    // Check if element exists
    $.fn.elExists = function () {
        return this.length > 0;
    };
